<?php
	// shows all the pending appointments
	include('../header.php');
	...
	if(isset($_POST['valueToSearch'])){
		...
		$query = "SELECT * FROM pendingAppointments WHERE hospitalId = $hospitalId AND CONCAT(`patientName`, `userContactNo`, `userAddress`, `userCity`, `appointmentDate`) LIKE '%".$valueToSearch."%'";
						 ...
						 <tr>
							...
							<td id="myBtn">
								...
								<a class="btn btn-danger" style="margin: 0px 5px;"
									href="hopitalAppointmentManage.php?id=<?=$row['id']?>">Delete
								</a>
